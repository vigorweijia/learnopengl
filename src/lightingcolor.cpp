...
void lighting_color() {
	...
	ShaderManager cubeColorShader("../src/shaders/lightingcolorshader/colorVS.glsl", "../src/shaders/lightingcolorshader/colorFS.glsl");
	ShaderManager lightSourceShader("../src/shaders/lightingcolorshader/lightsourceVS.glsl", "../src/shaders/lightingcolorshader/lightsourceFS.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		cubeColorShader.use();
		cubeColorShader.setVec3("lightColor", lightColor);
		cubeColorShader.setVec3("objectColor", objectColor);
		cubeColorShader.setMat4("projection", projection);
		cubeColorShader.setMat4("view", view);
		model = glm::mat4(1.0f);
		cubeColorShader.setMat4("model", model);
		glBindVertexArray(cubeVAO);
		glDrawArrays(GL_TRIANGLES, 0, 36);
