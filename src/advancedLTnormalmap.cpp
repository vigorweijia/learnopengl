...
void advancedLT_Normal_Mapping() {
	/*-------------  glfw initialization   --------------*/
	glfwInit();
	...
	/*-------------  use shader manager  ----------------*/
	ShaderManager shader("../src/shaders/advancedLTnormalmap/normalmappingVS.glsl", "../src/shaders/advancedLTnormalmap/normalmappingFS.glsl");

	/*--------------  load texture  ---------------------*/
	unsigned int diffuseMap = loadTexture("../resources/common/textures/brickwall.jpg");
	unsigned int normalMap = loadTexture("../resources/common/textures/brickwall_normal.jpg");
