...
void lighting_map() {
	...
	/*-------------  use shader manager  ----------------*/
	ShaderManager materialShader("../src/shaders/lightingmapshader/cubeVS.glsl", "../src/shaders/lightingmapshader/cubeFS.glsl");
	ShaderManager lightSourceShader("../src/shaders/lightingmapshader/lightsourceVS.glsl", "../src/shaders/lightingmapshader/lightsourceFS.glsl");
