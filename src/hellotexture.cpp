...
static void ProcessInputHelloeTexture(GLFWwindow* window);
...
void hello_texture() {
	...
	ShaderManager shaderManager("../src/shaders/textureshader/textureVertexShader.glsl", "../src/shaders/textureshader/textureFragmentShader.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shaderManager.use();
		// Activate GL_TEXTURE0 by default, no need to set uniform variable of fragmentShader
		glBindTexture(GL_TEXTURE_2D, texture);
		glBindVertexArray(VAO);
...
void hello_mixtexture() {
	...
	/*-------------  use shader manager  ----------------*/
	// working directory is under "build"
	ShaderManager shaderManager("../src/shaders/textureshader/textureVertexShader.glsl", "../src/shaders/textureshader/textureMixFragmentShader.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		/*----- process input ------*/
		ProcessInputHelloeTexture(window);
		...
		shaderManager.use();
		shaderManager.setFloat("mixValue", mixValue);
		glBindVertexArray(VAO);
		glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
